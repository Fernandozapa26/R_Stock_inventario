...
{
    /// <summary>
    /// DAO de Productos - CRUD para la tabla Productos.
    /// </summary>
    internal class ProductoDAO
    {
        ...
        public void Guardar(Producto p) => Insertar(p);
        public void EditarProducto(Producto p) => Editar(p);
        public void EliminarProducto(int id) => Eliminar(id);
    }
}
